...
from engine import evaluate_swig, Encoder_train_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--saved_model', default='CoFormer/checkpoint.pth',
                        help='path where saved model is')
    parser.add_argument('--train_saved_model', default=False, type=bool)
...
def main(args):
    ...
    if args.train_saved_model == True:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = Encoder_train_one_epoch(model, criterion, data_loader_train, optimizer, 
